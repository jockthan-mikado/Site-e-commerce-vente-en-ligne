		...
		<div class="row">
			...
			<div class="col-md-4 text-end">
				...
				<span class="dropdown"> <a href="cart.php"><button class="btn btn dropdown-toggle   " type="button"
							data-bs-toggle="dropdown" aria-expanded="false" style="color: #509FF3;">| My cart
			...
			<footer>
				...
				<div class="row">
					...
					<div class="col-md-4 text-center">
						<span style="color: #E67E22;">Follow us</span><br>
						<span style="color: #6E6E6E;">Twitter</span>
						<span style="color: #6E6E6E;">Facebook</span>
						<span style="color: #6E6E6E;">Youtube</span>
						<span style="color: #6E6E6E;">Instagram</span>
						<span style="color: #6E6E6E;">Linkedin</span>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 text-center">
						<p>&copy; 2023 WebDesign & Developed by YourName</p>
					</div>
				</div>
			</footer>
		</div>
