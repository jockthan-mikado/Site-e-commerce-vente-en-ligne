	...
	<body>
			...
			<div class="row mt-4">
				<div class="col-md-12">
					<div>
						...
						<span><font face="arial"><h1>Shoping Cart</h1></font></span>
					</div>
				</div>
				<div class="row">
						...
						<div class="col-md-12" style="background-color:#B4FEAE; border-radius: 5px; margin-left : 1%; width : 98%">
							<span class="checked">&#128504;</span><span class="added"><font face="arial">Consecteture Adipisicing 331 AA has been successfully added to your shopping cart. </font></span>
						</div>
        ...
        foreach ($_SESSION['cart'] as $productId => $item) {
            ...
            <tr>
				...
				<td>
					<input type="number" class="quantity-input"  width="35px" value="<?php echo $item['quantity']; ?>"
						data-product-id="<?php echo $productId; ?>" min="1">
				</td>
				<td class="subtotal"><?php echo $subtotal; ?></td>
				<td><a class="remove-from-cart" data-product-id="<?php echo $productId; ?>"><img
								src="images/cart-02.png"></a></td>
			</tr>
			<?php
		}
		?>
